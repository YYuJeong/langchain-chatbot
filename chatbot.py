...
def main():
    ...
    st.image('chatbot_image.png', width=1200)
    st.title("안녕하세요! RAG를 활용한 'AI 비서' 입니다")  # 시작 타이틀
        ...
        if pdf_docs:
            ...
            prompt = ChatPromptTemplate.from_messages(
                [
                    ...
                    "If you can't find the information from the PDF document, use the `web_search` tool for searching information from the web."),                    ("placeholder", "{chat_history}"),
